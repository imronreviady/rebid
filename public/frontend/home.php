<div class="main-header main-header-fullwidth main-header-has-header-standard">
			...
			<div class="header--standard-wrap">
				...
				<a href="#" class="logo">
					<div class="img-wrap">
						...
						<img src="<?=base_url()?>assets/frontend/img/logo-colored-small.png" alt="<?=$system_title?>" class="logo-colored">
					</div>
				...
				<a href="#" class="open-responsive-menu js-open-responsive-menu">
					<svg class="olymp-menu-icon"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-menu-icon"></use></svg>
				</a>
					...
					<div class="mCustomScrollbar">
						<ul>
							...
							<li class="shoping-cart more">
								<a href="#" class="nav-link">
									<svg class="olymp-shopping-bag-icon"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-shopping-bag-icon"></use></svg>
									...
									<ul>
										<li class="cart-product-item">
											<div class="product-thumb">
												<img src="<?=base_url()?>assets/frontend/img/product1.png" alt="product">
											</div>
											...
											<div class="more">
												<svg class="olymp-little-delete"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-little-delete"></use></svg>
											</div>
										</li>
										<li class="cart-product-item">
											<div class="product-thumb">
												<img src="<?=base_url()?>assets/frontend/img/product2.png" alt="product">
											</div>
											<div class="product-content">
			...
			<div class="col col-xl-5 ml-auto col-lg-6 col-md-12 col-sm-12 col-12">
				...
				<div class="registration-login-form">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#form-login" role="tab">
								<svg class="olymp-login-icon"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-login-icon"></use></svg>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#form-register" role="tab">
								<svg class="olymp-register-icon"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-register-icon"></use></svg>
							</a>
						</li>
					</ul>
					...
					<div class="tab-content">
						<div class="tab-pane" id="form-register" role="tabpanel" data-mh="log-tab">
									...
									<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
										...
										<div class="form-group date-time-picker label-floating">
											...
											<span class="input-group-addon">
															<svg class="olymp-calendar-icon"><use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-calendar-icon"></use></svg>
														</span>
										</div>
						...
						<div class="tab-pane active" id="form-login" role="tabpanel" data-mh="log-tab">
								...
								<div class="row">
									<div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<div class="form-group label-floating is-empty">
											...
											<input class="form-control" placeholder="" type="email" name="email" id="email" autocomplete="off" required>
										</div>
										<div class="form-group label-floating is-empty">
										...
										<a href="#" id="login" class="btn btn-lg btn-primary full-width"><?=get_phrase('login')?></a>
	...
	<img class="img-bottom" src="<?=base_url()?>assets/frontend/img/group-bottom.png" alt="friends">
	<img class="img-rocket" src="<?=base_url()?>assets/frontend/img/rocket.png" alt="rocket">
</div>
		...
		<div class="row">
			<div class="col col-xl-2 m-auto col-lg-2 col-md-6 col-sm-6 col-6">
				<a class="clients-item" href="#">
					<img src="<?=base_url()?>assets/frontend/img/client1.png" class="" alt="logo">
				</a>
			</div>
			<div class="col col-xl-2 m-auto col-lg-2 col-md-6 col-sm-6 col-6">
				<a class="clients-item" href="#">
					<img src="<?=base_url()?>assets/frontend/img/client2.png" class="" alt="logo">
				</a>
			</div>
			<div class="col col-xl-2 m-auto col-lg-2 col-md-6 col-sm-6 col-6">
				<a class="clients-item" href="#">
					<img src="<?=base_url()?>assets/frontend/img/client3.png" class="" alt="logo">
				</a>
			</div>
			<div class="col col-xl-2 m-auto col-lg-2 col-md-6 col-sm-6 col-6">
				<a class="clients-item" href="#">
					<img src="<?=base_url()?>assets/frontend/img/client4.png" class="" alt="logo">
				</a>
			</div>
			<div class="col col-xl-2 m-auto col-lg-2 col-md-6 col-sm-6 col-6">
				<a class="clients-item" href="#">
					<img src="<?=base_url()?>assets/frontend/img/client5.png" class="" alt="logo">
				</a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col col-xl-10 m-auto col-lg-10 col-md-12 col-sm-12 col-12">
				<img class="main-img" src="<?=base_url()?>assets/frontend/img/scale1.png" alt="screen">
			</div>
		</div>

		<img class="first-img1" alt="img" src="<?=base_url()?>assets/frontend/img/scale2.png">
		<img class="second-img1" alt="img" src="<?=base_url()?>assets/frontend/img/scale3.png">
		<img class="third-img1" alt="img" src="<?=base_url()?>assets/frontend/img/scale4.png">
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="<?=base_url()?>assets/frontend/img/icon-fly.png" alt="screen">
			</div>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			...
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="<?=base_url()?>assets/frontend/img/image1.png" alt="screen">
			</div>
		</div>
	</div>
</section>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="<?=base_url()?>assets/frontend/img/image2.png" alt="screen">
			</div>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			...
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="<?=base_url()?>assets/frontend/img/image3.png" alt="screen">
			</div>
		</div>
	</div>
</section>
...
<section class="medium-padding120 bg-section3 background-cover planer-animation">
						...
						<div class="crumina-module crumina-testimonial-item">
							...
							<div class="testimonial-item-content">
								...
								<div class="author-thumb">
									<img src="<?=base_url()?>assets/frontend/img/avatar3.jpg" alt="author">
								</div>
					...
					<div class="ui-block swiper-slide">
						...
						<div class="crumina-module crumina-testimonial-item">
							...
							<div class="testimonial-item-content">
								...
								<div class="author-thumb">
									<img src="<?=base_url()?>assets/frontend/img/avatar17.jpg" alt="author">
								</div>
					...
					<div class="ui-block swiper-slide">
						...
						<div class="crumina-module crumina-testimonial-item">
							...
							<div class="testimonial-item-content">
								...
								<div class="author-thumb">
									<img src="<?=base_url()?>assets/frontend/img/avatar1.jpg" alt="author">
								</div>
	...
	<img src="<?=base_url()?>assets/frontend/img/planer.png" alt="planer" class="planer">
</section>
...
<section class="medium-padding120">
	<div class="container">
		<div class="row">
			<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
				<img src="<?=base_url()?>assets/frontend/img/image4.png" alt="screen">
			</div>
			...
			<div class="col col-xl-5 col-lg-5 m-auto col-md-12 col-sm-12 col-12">
				...
				<a href="#" class="btn btn-market">
					<img class="icon" src="<?=base_url()?>assets/frontend/svg-icons/apple-logotype.svg" alt="app store">
					<div class="text">
				...
				<a href="#" class="btn btn-market">
					<img class="icon" src="<?=base_url()?>assets/frontend/svg-icons/google-play.svg" alt="google">
					<div class="text">
...
<section class="medium-padding100 subscribe-animation scrollme bg-users">
	<div class="container">
		...
		<img src="<?=base_url()?>assets/frontend/img/paper-plane.png" alt="plane" class="plane">
	</div>
</section>
		...
		<div class="row">
			<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
				...
				<article class="hentry blog-post">
					...
					<div class="post-thumb">
						<img src="<?=base_url()?>assets/frontend/img/post1.jpg" alt="photo">
					</div>
			...
			<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
				...
				<article class="hentry blog-post">
					...
					<div class="post-thumb">
						<img src="<?=base_url()?>assets/frontend/img/post2.jpg" alt="photo">
					</div>
			...
			<div class="col col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
				...
				<article class="hentry blog-post">
					...
					<div class="post-thumb">
						<img src="<?=base_url()?>assets/frontend/img/post3.jpg" alt="photo">
					</div>
					...
					<div class="post-content">
						...
						<div class="post-additional-info inline-items">
							...
							<ul class="friends-harmonic">
								<li>
									<a href="#">
										<img src="<?=base_url()?>assets/frontend/img/icon-chat28.png" alt="icon">
									</a>
								</li>
							</ul>
							<div class="names-people-likes">
...
<section class="align-right pt160 pb80 section-move-bg call-to-action-animation scrollme">
	...
	<img class="first-img" alt="guy" src="<?=base_url()?>assets/frontend/img/guy.png">
	<img class="second-img" alt="rocket" src="<?=base_url()?>assets/frontend/img/rocket1.png">
						...
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#home1" role="tab">
								<svg class="olymp-login-icon">
									<use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-login-icon"></use>
								</svg>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#profile1" role="tab">
								<svg class="olymp-register-icon">
									<use xlink:href="<?=base_url()?>assets/frontend/svg-icons/sprites/icons.svg#olymp-register-icon"></use>
								</svg>
							</a>
						</li>
					</ul>
		...
		<div class="row">
			<div class="col col-lg-4 col-md-4 col-sm-6 col-6">
				...
				<div class="widget w-about">
					...
					<a href="02-ProfilePage.html" class="logo">
						<div class="img-wrap">
							<img src="<?=base_url()?>assets/frontend/img/logo-colored.png" alt="<?=$system_title?>">
						</div>
						<div class="title-block">
							<h6 class="logo-title"><?=strtolower($system_title)?></h6>
							<div class="sub-title">BID . WORK . GET PAY</div>
			...
			<div class="col col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="sub-footer-copyright">
					<span>
						Copyright <a href="<?=base_url()?>"><?=$system_title?></a> All Rights Reserved <?=date('Y')?>
					</span>
				</div>
